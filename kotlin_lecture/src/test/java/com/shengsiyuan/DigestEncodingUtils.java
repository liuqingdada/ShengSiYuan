...
public class DigestEncodingUtils {
     ...
     * Encode the data with HEX (Base16) encoding and with uppercase letters.
     */
    public static String encodeWithHex(byte[] bytes, int startPos, int endPos) {
        return encodeWithHex(bytes, startPos, endPos, true);
    }

    public static String encodeWithHex(byte[] bytes, int startPos, int endPos, boolean uppercase) {
