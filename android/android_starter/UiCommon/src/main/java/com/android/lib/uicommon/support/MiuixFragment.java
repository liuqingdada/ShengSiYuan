 ...
 */
public abstract class MiuixFragment extends Fragment implements ISupportFragment {
    final SupportFragmentDelegate mDelegate = new SupportFragmentDelegate(this);
    protected MiuixActivity miuixActivity;

    public MiuixFragment(@LayoutRes int contentLayoutId) {
        super();
        try {
            Field mContentLayoutId = ReflectionUtils.findField(getClass(), "mContentLayoutId");
            mContentLayoutId.setAccessible(true);
    ...
    public void onAttach(@NotNull Context context) {
        ...
        mDelegate.onAttach();
        miuixActivity = (MiuixActivity) mDelegate.getActivity();
    }
    ...
    /**
     * 类似  {@link Activity#onActivityResult(int, int, Intent)} (int, int, Intent)}
     * <p>
