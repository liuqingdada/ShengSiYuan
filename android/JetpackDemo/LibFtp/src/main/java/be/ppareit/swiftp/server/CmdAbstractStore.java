    ...
    public void doStorOrAppe(String param, boolean append) {
        ...
        storing:
        {
            ...
            try {
                if (storeFile.exists()) {
                    if (!append) {
                        if (!FileUtil.deleteFile(storeFile, FtpInitializer.getAppContext())) {
                ...
                if (!storeFile.exists()) {
                    FileUtil.mkfile(storeFile, FtpInitializer.getAppContext());
                }
                out = FileUtil.getOutputStream(storeFile, FtpInitializer.getAppContext());
