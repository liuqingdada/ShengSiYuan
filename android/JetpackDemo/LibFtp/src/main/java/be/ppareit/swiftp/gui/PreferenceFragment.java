...
public class PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!FtpInitializer.isFreeVersion()) {
            prefScreen.removePreference(marketVersionPref);
        }
        if (!(FtpInitializer.isPackageInstalled("com.android.vending") ||
                FtpInitializer.isPackageInstalled("com.google.market"))) {
            prefScreen.removePreference(marketVersionPref);
        }
    ...
    public void onResume() {
        ...
        PreferenceManager.getDefaultSharedPreferences(FtpInitializer.getAppContext())
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        switch (key) {
            ...
            case "autoconnect_preference":
                AutoConnect.maybeStartService(FtpInitializer.getAppContext());
                break;
        }
    }
